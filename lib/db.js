...
const stmtCreateOrder = db.prepare(`
  INSERT INTO orders (id, user_id, customer_name, customer_email, customer_phone, customer_address, items, total, status, created_at, note, discount_code, discount, shipping, street, postal_code, city, delivery_method, parcel_locker, parcel_locker_addr)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`);
function createOrder(o) {
  stmtCreateOrder.run(o.id, o.user_id ?? null, o.customer.name, o.customer.email,
    ...
    o.deliveryMethod || 'kurier', o.parcelLocker || '', o.parcelLockerAddr || '');
  return o;
}
