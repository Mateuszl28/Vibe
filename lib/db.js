...
const stmtInsertProduct = db.prepare(`
  INSERT INTO products (id, name, category, price, colors, sizes, color, accent, description, featured, sort, created_at)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`);
...
module.exports = {
  ...
  countProducts, getAllProducts, getProductById, createProduct, updateProduct, deleteProduct, seedProductsIfEmpty
};
