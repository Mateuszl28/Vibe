...
const stmtCreateOrder = db.prepare(`
  INSERT INTO orders (id, user_id, customer_name, customer_email, customer_phone, customer_address, items, total, status, created_at, note, discount_code, discount, shipping, street, postal_code, city)
  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
`);
...
module.exports = {
  ...
  createOrder, countOrders, getOrdersByUser, getAllOrders, updateOrderStatus, deleteOrder, decrementStock, setOrderNote,
