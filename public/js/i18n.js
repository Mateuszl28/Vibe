...
(function () {
  ...
  // Regulamin — brakujace fragmenty §5–§12 + wzor formularza odstapienia
  const LEGAL_EN2 = [
    { pl: 'Konsument', en: 'Consumer' },
    { pl: 'W przypadku ogłoszenia obniżki ceny Towaru Sprzedawca uwidacznia obok informacji o obniżce', en: 'In the event of an announced reduction in the price of Goods, the Seller displays, next to the information about the reduction,' },
    { pl: 'Dostawa realizowana jest na terytorium Polski. Sposoby, koszty i orientacyjny czas dostawy opisane są na stronie', en: 'Delivery is made within the territory of Poland. The methods, costs and approximate delivery times are described on the' },
    { pl: 'Konsument ponosi odpowiedzialność za zmniejszenie wartości Towaru będące wynikiem korzystania z niego w sposób wykraczający poza konieczny do stwierdzenia charakteru, cech i funkcjonowania Towaru (np. przymierzenie jest dozwolone; noszenie, pranie, usunięcie metek — nie).', en: 'The Consumer is liable for any diminished value of the Goods resulting from using them in a manner going beyond what is necessary to establish the nature, characteristics and functioning of the Goods (e.g. trying on is permitted; wearing, washing, removing tags — is not).' },
    { pl: 'Prawo odstąpienia nie przysługuje m.in. w odniesieniu do umów wskazanych w art. 38 ustawy o prawach konsumenta, w szczególności gdy przedmiotem świadczenia jest rzecz nieprefabrykowana, wyprodukowana według specyfikacji Konsumenta lub służąca zaspokojeniu jego zindywidualizowanych potrzeb (np. odzież z personalizowanym nadrukiem na zamówienie).', en: 'The right of withdrawal does not apply, among others, to the contracts specified in Article 38 of the Consumer Rights Act, in particular where the subject of performance is a non-prefabricated item, made to the Consumer\'s specifications or serving to satisfy their individualised needs (e.g. clothing with a custom-made print to order).' },
    { pl: 'Adresat: VIP Domagała Nieruchomości Paweł Domagała, ul. Pszenna 30, 64-115 Wilkowice, e-mail: kontakt@vibeleszno.com', en: 'Addressee: VIP Domagała Nieruchomości Paweł Domagała, ul. Pszenna 30, 64-115 Wilkowice, e-mail: kontakt@vibeleszno.com' },
    { pl: 'Ja/My(*) niniejszym informuję/informujemy(*) o moim/naszym odstąpieniu od umowy sprzedaży następujących rzeczy: …', en: 'I/We(*) hereby give notice that I/we(*) withdraw from the sales contract for the following items: …' },
    { pl: 'Data zawarcia umowy(*)/odbioru(*): …', en: 'Date of conclusion of the contract(*)/receipt(*): …' },
    { pl: 'Imię i nazwisko konsumenta(-ów): …', en: 'Name of the consumer(s): …' },
    { pl: 'Adres konsumenta(-ów): …', en: 'Address of the consumer(s): …' },
    { pl: 'Numer zamówienia (opcjonalnie, przyspieszy obsługę): …', en: 'Order number (optional, will speed up processing): …' },
    { pl: 'Podpis (tylko jeżeli formularz jest przesyłany w wersji papierowej): …', en: 'Signature (only if this form is sent on paper): …' },
    { pl: 'Data: …', en: 'Date: …' },
    { pl: '(*) Niepotrzebne skreślić.', en: '(*) Delete as appropriate.' },
    { pl: 'Sprzedawca ma obowiązek dostarczyć Towar zgodny z umową. Wobec Konsumentów i Przedsiębiorców na prawach konsumenta Sprzedawca ponosi odpowiedzialność za brak zgodności Towaru z umową na zasadach określonych w', en: 'The Seller is obliged to deliver Goods that are in conformity with the contract. Towards Consumers and Entrepreneurs with consumer rights, the Seller is liable for any non-conformity of the Goods with the contract under the rules set out in' },
    { pl: 'rozdziale 5a ustawy o prawach konsumenta', en: 'Chapter 5a of the Consumer Rights Act' },
    { pl: '(wobec pozostałych przedsiębiorców — rękojmia z Kodeksu cywilnego).', en: '(towards other entrepreneurs — the warranty under the Civil Code).' },
    { pl: 'Sprzedawca odpowiada za brak zgodności Towaru z umową istniejący w chwili dostarczenia i ujawniony w ciągu', en: 'The Seller is liable for any non-conformity of the Goods with the contract existing at the time of delivery and revealed within' },
    { pl: '2 lat', en: '2 years' },
    { pl: 'od dostarczenia. Domniemywa się, że brak zgodności, który ujawnił się przed upływem 2 lat, istniał w chwili dostarczenia.', en: 'of delivery. It is presumed that a non-conformity revealed before the lapse of 2 years existed at the time of delivery.' },
    { pl: 'W razie niezgodności Towaru z umową Konsument może żądać jego', en: 'In the event of non-conformity of the Goods with the contract, the Consumer may demand their' },
    { pl: 'naprawy lub wymiany', en: 'repair or replacement' },
    { pl: '. Jeżeli naprawa/wymiana jest niemożliwa, wymagałaby nadmiernych kosztów, Sprzedawca nie doprowadził Towaru do zgodności z umową lub brak zgodności jest istotny — Konsument może złożyć oświadczenie o', en: '. If repair/replacement is impossible, would require excessive costs, the Seller has failed to bring the Goods into conformity with the contract, or the non-conformity is material — the Consumer may submit a statement of' },
    { pl: 'obniżeniu ceny', en: 'price reduction' },
    { pl: 'albo', en: 'or' },
    { pl: 'odstąpieniu od umowy', en: 'withdrawal from the contract' },
    { pl: 'Reklamację można złożyć e-mailem na adres kontaktowy lub pisemnie, podając: dane Klienta, numer zamówienia, opis niezgodności i żądanie. Towar podlegający reklamacji Sprzedawca odbiera na swój koszt lub zwraca Klientowi koszt odesłania.', en: 'A complaint may be submitted by e-mail to the contact address or in writing, providing: the Customer\'s details, the order number, a description of the non-conformity and the demand. The Seller collects the Goods subject to the complaint at its own expense or reimburses the Customer for the cost of return shipping.' },
    { pl: 'Sprzedawca udziela odpowiedzi na reklamację w terminie', en: 'The Seller responds to a complaint within' },
    { pl: 'od jej otrzymania. Brak odpowiedzi w tym terminie oznacza uznanie reklamacji.', en: 'of receiving it. Failure to respond within this period means the complaint is deemed accepted.' },
    { pl: 'Opinie w Sklepie mogą dodawać wyłącznie zalogowani Klienci, którzy', en: 'Reviews in the Shop may be added only by logged-in Customers who' },
    { pl: 'kupili dany Towar', en: 'have purchased the given Goods' },
    { pl: '— Sprzedawca weryfikuje to automatycznie na podstawie historii zamówień. Dzięki temu publikowane opinie pochodzą od osób, które rzeczywiście nabyły produkt.', en: '— the Seller verifies this automatically on the basis of order history. As a result, the published reviews come from people who have actually purchased the product.' },
    { pl: 'Opinie podlegają moderacji wyłącznie pod kątem treści bezprawnych, wulgarnych lub niezwiązanych z Towarem. Sprzedawca nie usuwa opinii z powodu ich negatywnego charakteru ani nie publikuje opinii fikcyjnych.', en: 'Reviews are moderated solely with regard to unlawful, vulgar or off-topic content unrelated to the Goods. The Seller does not remove reviews because of their negative nature, nor does it publish fictitious reviews.' },
    { pl: 'Konsument może skorzystać z pozasądowych sposobów rozpatrywania reklamacji i dochodzenia roszczeń, m.in.: z pomocy', en: 'The Consumer may use out-of-court methods of handling complaints and pursuing claims, including, among others: the assistance of the' },
    { pl: 'powiatowego (miejskiego) rzecznika konsumentów', en: 'district (municipal) consumer ombudsman' },
    { pl: ', organizacji konsumenckich (np. Federacja Konsumentów),', en: ', consumer organisations (e.g. the Consumer Federation),' },
    { pl: 'wojewódzkich inspektoratów Inspekcji Handlowej', en: 'the provincial inspectorates of the Trade Inspection' },
    { pl: '(mediacja, stałe sądy polubowne).', en: '(mediation, permanent arbitration courts).' },
    { pl: 'Szczegółowe informacje dostępne są na stronie Urzędu Ochrony Konkurencji i Konsumentów:', en: 'Detailed information is available on the website of the Office of Competition and Consumer Protection:' },
    { pl: 'Skorzystanie z pozasądowych sposobów jest dobrowolne dla obu stron.', en: 'The use of out-of-court methods is voluntary for both parties.' },
    { pl: 'Administratorem danych osobowych Klientów jest Sprzedawca. Zasady przetwarzania danych, podstawy prawne, okresy przechowywania i prawa osób, których dane dotyczą, opisuje', en: 'The controller of Customers\' personal data is the Seller. The rules of data processing, the legal bases, retention periods and the rights of data subjects are described in the' },
    { pl: 'Sprzedawca może zmienić Regulamin z ważnych przyczyn (np. zmiana przepisów, metod płatności lub dostawy). Do zamówień złożonych przed zmianą stosuje się Regulamin w brzmieniu z dnia złożenia zamówienia. O zmianie Regulaminu Klienci posiadający konto zostaną poinformowani z co najmniej 14-dniowym wyprzedzeniem.', en: 'The Seller may amend these Terms and Conditions for important reasons (e.g. changes in legislation, payment or delivery methods). Orders placed before the change are subject to the Terms and Conditions in the wording in force on the date the order was placed. Customers who have an account will be informed of any change to the Terms and Conditions at least 14 days in advance.' },
    { pl: 'Żadne postanowienie Regulaminu nie wyłącza ani nie ogranicza uprawnień Konsumentów wynikających z bezwzględnie obowiązujących przepisów prawa. W razie sprzeczności pierwszeństwo mają te przepisy.', en: 'No provision of these Terms and Conditions excludes or limits the rights of Consumers arising from mandatory provisions of law. In the event of any conflict, those provisions prevail.' },
    { pl: 'W sprawach nieuregulowanych stosuje się prawo polskie, w szczególności Kodeks cywilny, ustawę o prawach konsumenta oraz ustawę o świadczeniu usług drogą elektroniczną. Wybór prawa nie pozbawia Konsumenta ochrony przyznanej mu przepisami państwa jego zwykłego pobytu.', en: 'In matters not regulated herein, Polish law applies, in particular the Civil Code, the Consumer Rights Act and the Act on Providing Services by Electronic Means. The choice of law does not deprive the Consumer of the protection afforded to them by the provisions of their country of habitual residence.' }
  ];
  LEGAL_EN2.forEach((p) => { EN[p.pl] = p.en; });
